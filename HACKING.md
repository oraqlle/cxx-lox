...
hidden if the `CLOX_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `CLOX_DEVELOPER_MODE` to the configure
...
Runs the executable target `clox_exe`.
